...
def parse_args():    
    ...
    parser.add_argument('-prompt', type=str, default='None', help='type of prompt, bbox or click')
    parser.add_argument('-prompt_freq', type=int, default=4, help='frequency of giving prompt in 3D images')
